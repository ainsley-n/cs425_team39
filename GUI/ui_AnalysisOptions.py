...
class Ui_AnalysisWindow(object):
    def setupUi(self, AnalysisWindow):
        ...
        self.ExportCircuitBtn = QtWidgets.QPushButton(self.AnalysisButtons)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ExportCircuitBtn.sizePolicy().hasHeightForWidth())
        self.ExportCircuitBtn.setSizePolicy(sizePolicy)
        self.ExportCircuitBtn.setObjectName("ExportCircuitBtn")
        self.gridLayout.addWidget(self.ExportCircuitBtn, 5, 0, 1, 1)
        ...
        self.switchResult = QtWidgets.QPushButton(self.widget)
        self.switchResult.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.switchResult.sizePolicy().hasHeightForWidth())
        self.switchResult.setSizePolicy(sizePolicy)
        self.switchResult.setObjectName("switchResult")
        self.horizontalLayout.addWidget(self.switchResult, 0, QtCore.Qt.AlignHCenter)
        ...
        self.horizontalLayout.addWidget(self.exportButton, 0, QtCore.Qt.AlignRight)
    ...
    def retranslateUi(self, AnalysisWindow):
        ...
        self.ExportCircuitBtn.setText(_translate("AnalysisWindow", "Export Circuit"))
        ...
        self.switchResult.setText(_translate("AnalysisWindow", "Show Simplified Circuit"))
        self.exportButton.setText(_translate("AnalysisWindow", "Export"))
